...
<div class="flex justify-between items-center">
    ...
    <div class="flex gap-3">
        ...
        <button type="submit"
            ...
            class="inline-flex items-center rounded-lg py-4 px-10 gap-1 text-sm text-white font-poppins font-medium bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-[0_3px_4px_rgba(59,130,246,0.4)] transition duration-300 cursor-pointer">Simpan Data
        </button>
    </div>
</div>

<form id="formTahun_ajaran" action="/poin_pelanggaran_siswa/process/tahun_ajaran/insert.php" method="POST" autocomplete="off">
