...
<div class="flex justify-between">
    <div>
        ...
        <p>Daftar Pelanggaran Siswa di atas 50 Point</p>
    </div>
    ...
    <?php if (
        ...
        <div>
            <a href="pages/laporan/perjanjian_ortu/daftar_siswa/init.php"
                ...
                ?>
                            ...
                            <td class="px-4 py-4 flex flex-col gap-4">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    ?>
                                        <?php if (
                                            ...
                                            <a href="pages/laporan/perjanjian_ortu/daftar_siswa/add.php?nis=<?= $row['nis']; ?>"
                                    ...
                                    <?php
                                    $resultfoto = mysqli_query($conn, "SELECT foto_dokumen as data FROM perjanjian_orang_tua WHERE nis='" . $row['nis'] . "'");
                                    ...
                                    ?>
                                        <?php if ($_SESSION['user']['role'] == 'Guru BK' || 'Kepala Sekolah' || 'Wakasek' || 'Guru'): ?>
                                            <a href="uploads/perjanjian_ortu/<?= $count_foto['data']; ?>"
                                ...
                                ?>
                                    <?php if ($_SESSION['user']['role'] == 'Guru BK'): ?>
                                        <form action="process/laporan_surat_perjanjian_ortu/upload.php" method="POST" enctype="multipart/form-data" class="w-full">
                    ...
                    <tr>
                        <td colspan="6" class="text-center py-10 text-gray-500">
                            Tidak ada data siswa dengan poin 50 - 100
                        </td>
                    </tr>
                <?php } ?>
...
<div class="mt-16">
    ...
    <h2 class="text-3xl font-urbanist font-extrabold mb-2">Daftar Surat Perjanjian Ortu/Wali</h2>
    <p>Daftar Siswa Sudah Cetak Surat Perjanjian Ortu / Wali</p>
                            ...
                            <tr class="bg-white font-medium font-poppins text-sm">
                                ...
                                <?php if (
                                    ...
                                    <td class="px-4 py-4 text-center">
                                        <a href="pages/cetak/surat_perjanjian_ortu.php?nis=<?= $row['nis']; ?>"
