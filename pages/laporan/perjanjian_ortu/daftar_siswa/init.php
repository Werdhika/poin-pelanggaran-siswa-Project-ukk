...
<div class="flex justify-between items-start px-24">
    <div>
        <h2 class="font-urbanist font-extrabold text-3xl mb-2">Surat Perjanjian Ortu</h2>
...
<form id="formPerjanjian_ortu_init" action="pages/laporan/perjanjian_ortu/daftar_siswa/add.php" method="POST">
