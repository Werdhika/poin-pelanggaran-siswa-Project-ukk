...
<div class="no-print flex justify-center my-4">
    <div class="flex items-center gap-3">
        ...
        <!-- Tombol Kembali -->
        <button
            onclick="window.history.length > 1 ? history.back() : window.location.href='/poin_pelanggaran_siswa/'"
            class="inline-flex items-center gap-2 rounded-lg py-3 px-5 text-sm text-white font-poppins font-medium bg-slate-600 hover:bg-slate-700 shadow transition duration-300">
...
<div class="min-h-screen bg-gray-100 py-10">
    ...
    <div class="page max-w-3xl mx-auto my-6 p-10 bg-white border border-gray-300 shadow-xl rounded-sm ring-1 ring-gray-200">
