...
@$nis = $_GET['nis'];
$resultNis = mysqli_query($conn, "SELECT nis, nama_siswa FROM siswa");

?>

<div class="flex justify-between items-start px-24">
    <div>
        <h2 class="font-urbanist font-extrabold text-3xl mb-2">Surat Perjanjian Siswa</h2>
        <p>Silahkan isi data surat perjanjian siswa yang akan ditambahkan.</p>
    </div>

    <div class="flex gap-3">
        <!-- button batal simpan -->
        <a href="pages/laporan/perjanjian_siswa/daftar_siswa/list.php"
...
<form id="formPerjanjian_siswa_init" action="pages/laporan/perjanjian_siswa/daftar_siswa/add.php" method="POST">
            ...
            <div class="bg-white rounded-md shadow-md overflow-hidden">
                ...
                <div class="p-10 space-y-6 font-poppins font-medium text-sm rounded-b-lg border-2 border-t-0 border-gray-200">
                    <div class="flex gap-4 w-full items-end">
                        ...
                        <div class="flex-2">
                            ...
                            <div class="relative">
                                <select
                                    ...
                                    <?php
                                    while ($siswa = mysqli_fetch_assoc($resultNis)) { ?>
                        ...
                        <div>
                            <button type="submit"
                                form="formPerjanjian_siswa_init"
                                class="inline-flex items-center rounded-lg py-3.5 px-6 text-sm text-white font-poppins font-medium bg-amber-400 transition duration-300 cursor-pointer">Print Surat
                            </button>
                        </div>
                    </div>
                </div>
