...
<div class="flex justify-between items-start px-24">
    <div>
        <h2 class="font-urbanist font-extrabold text-3xl mb-2">Tambah Surat Perjanjian Siswa</h2>
        <p>Silahkan isi data surat perjanjian siswa yang akan ditambahkan.</p>
    </div>

    <div class="flex gap-3">
        <!-- button batal simpan -->
        <a href="/poin_pelanggaran_siswa/pages/laporan/perjanjian_siswa/daftar_siswa/list.php"
...
<form id="formPerjanjian_ortu" action="/poin_pelanggaran_siswa/process/laporan_surat_perjanjian_siswa/insert.php" method="POST">
