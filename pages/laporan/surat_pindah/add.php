...
$resultNis = mysqli_query($conn, "SELECT COUNT(*) as data FROM surat_pindah WHERE nis='$nis'");
$count_nis = mysqli_fetch_assoc($resultNis);
if ($count_nis['data'] > 0) {
    echo "<script>window.alert('Maaf, Surat Pemanggilan Orang Tua Sudah Ada')
    window.location='pages/laporan/surat_pindah/init.php'</script>";
}
...
<div class="flex justify-between items-start px-24">
    <div>
        <h2 class="font-urbanist font-extrabold text-3xl mb-2">Tambah Surat Pindah</h2>
        <p>Silahkan isi data surat pindah siswa yang akan ditambahkan.</p>
    </div>
...
<form id="form_surat_pindah" action="/poin_pelanggaran_siswa/process/laporan_surat_pindah/insert.php" method="POST">
            ...
            <div class="bg-white rounded-md shadow-md overflow-hidden">
                ...
                <div class="p-10 space-y-6 font-poppins font-medium text-sm rounded-b-lg border-2 border-t-0 border-gray-200">
                    <div class="flex gap-4 w-full">
                        ...
                        <div class="flex-1">
                            <label class="block mb-2 font-semibold">No Surat</label>
                            <input
                                type="number"
                                name="no_surat"
                                value=""
                        ...
                        <div class="flex-1">
                            <label class="block mb-2 font-semibold">Pindah Ke</label>
                            <input
                                type="text"
                                name="sekolah_tujuan"
                                value=""
