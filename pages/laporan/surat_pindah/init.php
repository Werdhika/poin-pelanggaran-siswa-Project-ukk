...
<div class="flex justify-between items-start px-24">
    <div>
        <h2 class="font-urbanist font-extrabold text-3xl mb-2">Surat Pindah</h2>
        <p>Silahkan isi data surat keluar yang akan ditambahkan.</p>
    </div>

    <div class="flex gap-3">
        <!-- button batal simpan -->
        <a href="pages/laporan/perjanjian_ortu/daftar_siswa/list.php"
...
<form id="form_surat_keluar_init" action="pages/laporan/surat_pindah/add.php" method="POST">
