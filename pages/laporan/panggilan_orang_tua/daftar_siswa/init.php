...
<div class="flex justify-between items-start px-24">
    <div>
        <h2 class="font-urbanist font-extrabold text-3xl mb-2">Tambah Surat Panggilan Ortu</h2>
        <p>Silahkan pilih NIS untuk surat panggilan ortu yang akan ditambahkan.</p>
    </div>
...
<form id="formpanggilan_ortu_init" action="pages/laporan/panggilan_orang_tua/daftar_siswa/add.php" method="POST">
