...
<div class="flex justify-between">
    <h2 class="text-5xl font-urbanist font-bold">Data siswa</h2>

    <!-- Button -->
    <div class="flex gap-3">
        <!-- button Print -->
        <a class="inline-flex items-center rounded-lg border border-gray-300 py-3.5 px-5 gap-1 text-sm font-poppins font-medium bg-linear-to-r hover:from-blue-600 hover:to-indigo-600 hover:text-white hover:shadow-[0_8px_20px_rgba(59,130,246,0.5)] hover:border-transparent transition duration-300" href="#">
...
<div class="flex items-center z-10 mt-16 justify-between rounded-md ">
    ...
    <div class="inline-flex font-poppins text-sm font-medium">
        <a href="#"
            class="px-5 py-3 rounded-lg bg-linear-to-r from-blue-600 to-indigo-600 shadow-[0_3px_10px_rgba(59,130,246,0.5)] font-semibold text-white">
            Semua
        </a>
        <a href="#"
            class="px-5 py-3 rounded-lg text-gray-500 hover:text-gray-900">
            Aktif
        </a>
        <a href="#"
            class="px-5 py-3 rounded-lg text-gray-500 hover:text-gray-900">
...
<!-- Table Siswa -->
<div class="relative overflow-auto border border-gray-200 rounded-lg shadow-sm mt-8">
    <table class="w-full text-sm text-left">
        <thead class="font-poppins font-medium bg-gray-100 text-sm text-gray-700 sticky top-0 z-10 shadow-md">
            <tr>
                ...
                <th scope="col" class="px-6 py-4 font-semibold text-gray-700">
                    NIS
                </th>
                <th scope="col" class="px-6 py-4 font-semibold text-gray-700">
                    Nama Siswa
