...
<div class="flex justify-between">
    <h2 class=" text-3xl font-urbanist font-bold">Data siswa</h2>

    <!-- Button -->
    <div class="flex gap-2.5">
        <!-- button Download -->
        <a class="inline-flex items-center rounded-md border border-gray-300 py-2.5 px-4 gap-1 text-sm font-poppins font-medium bg-linear-to-r hover:from-blue-600 hover:to-indigo-600 hover:text-white hover:shadow-[0_8px_20px_rgba(59,130,246,0.5)] hover:border-transparent transition duration-300" href="#">
        ...
        <!-- button Tambah Siswa -->
        <a class="group inline-flex items-center rounded-md py-2.5 px-4 gap-1 text-sm text-white font-poppins font-medium bg-linear-to-r from-blue-600 to-indigo-600
               hover:from-blue-700 hover:to-indigo-700 shadow-[0_8px_20px_rgba(59,130,246,0.5)] transition duration-300" href="pages/siswa/add.php">
...
<div class="flex items-center z-10 mt-16 justify-between rounded-md ">
    ...
    <div class="inline-flex font-poppins text-sm font-medium">
        <a href="#"
            class="px-4 py-2 rounded-md bg-linear-to-r from-blue-600 to-indigo-600 shadow-[0_3px_10px_rgba(59,130,246,0.5)] font-semibold text-white">
            Semua
        </a>
        <a href="#"
            class="px-4 py-2 rounded-md text-gray-500 hover:text-gray-900">
            Aktif
        </a>
        <a href="#"
            class="px-4 py-2 rounded-md text-gray-500 hover:text-gray-900">
    ...
    <div>
        <div class="relative group">
            ...
            <input type="text" id="input-group-1" class="w-full ps-10 py-2 pe-4 font-poppins text-sm font-medium placeholder:font-poppins placeholder:text-[13px] rounded-md border border-gray-300 focus:outline-none focus:border-black transition duration-200" placeholder="Cari Nama atau NIS ">
        </div>
    </div>
</div>

<!-- Table Siswa -->
<div class="relative max-h-screen overflow-auto rounded-md shadow-md mt-8 border-2 border-gray-200">
    <table class="w-full divide-y-2 divide-gray-700 bg-gray-50">
        <thead class="font-urbanist text-white bg-linear-to-r from-blue-600 to-indigo-600">
            <tr class="text-left">
        ...
        <tbody class="divide-y-2 divide-gray-200">
            ...
            while ($data = mysqli_fetch_assoc($result)) { ?>
                <tr class="bg-white hover:bg-gray-100 font-medium font-poppins text-sm">
                    <td class="w-4 px-4">
                        <div class="flex items-center">
                    ...
                    <td class="px-6 py-2"><?= $data['nis']; ?></td>
                    <td class="px-4 py-2"><?= $data['nama_siswa']; ?></td>
                    <td class="px-6 py-2"><?= $data['jenis_kelamin']; ?></td>
                    <td class="px-6 py-2"><?= $data['status']; ?></td>
                    <td class="px-6 py-2">
