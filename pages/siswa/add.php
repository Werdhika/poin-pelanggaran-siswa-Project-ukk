...
<div class="px-20 md:px-8 lg:px-16">
    <h2 class="mt-12 font-heading text-4xl mb-8  font-semibold">Tambah Data Siswa</h2>
                ...
                <div>
                    <label for="kelas">
                        ...
                        <select name="kelas" id="kelas" class="w-full border border-gray-300 p-2 rounded">
                            ...
                            <option value="JM">XII RPL 1</option>
                            <option value="SRV">XII RPL 2</option>
                            <option value="JH">XII RPL 3</option>
                            <option value="BBK">XII RPL 4</option>
                            <option value="AK">XII RPL 5</option>
                            <option value="BG">XII DKV 1</option>
                            <option value="EC">XII DKV 2</option>
                            <option value="EC">XII DKV 3</option>
                            <option value="EC">XII DKV 4</option>
                            <option value="EC">XII DKV 5</option>
                            <option value="EC">XII AN 1</option>
                        </select>
                    </label>
                </div>
                <div>
