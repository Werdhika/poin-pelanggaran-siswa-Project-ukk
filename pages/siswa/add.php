...
$nis = mysqli_query($conn, "SELECT MAX(nis) as nisAkhir FROM siswa");
$dataNis = mysqli_fetch_assoc($nis);

$nisAkhir = $dataNis['nisAkhir'];
if ($nisAkhir == null) {
    $nisBaru = 1;
} else {
    $nisBaru = $nisAkhir + 1;
...
<!-- Form Data Siswa -->
<form id="formSiswa" action="/poin_pelanggaran_siswa/process/siswa/siswa_insert.php" method="POST">
                    ...
                    <div class="flex gap-4 w-full">
                        ...
                        <div class="flex-2">
                            ...
                            <input
                                ...
                                name="nis"
                                value="<?= $nisBaru; ?>"
                                class="w-full border border-gray-300 p-2 rounded-md box-border text-center" readonly>
                        </div>
