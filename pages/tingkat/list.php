...
$result = mysqli_query($conn, "SELECT * FROM tingkat");
?>
...
<div class="flex justify-between items-ceanter">
    ...
    <div class="flex py-2 justify-center gap-3">
        <a href="pages/tingkat/add.php" class="group inline-flex items-center rounded-lg py-4 px-6 gap-1 text-sm text-white font-poppins font-medium bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-[0_3px_4px_rgba(59,130,246,0.4)] transition duration-300">
