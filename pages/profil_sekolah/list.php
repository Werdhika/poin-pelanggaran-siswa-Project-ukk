...
$result = mysqli_query($conn, "SELECT * FROM profil_sekolah");
?>

<div class="flex justify-between">
    <div>
        <h2 class="text-3xl font-urbanist font-extrabold mb-2">Data Profil Sekolah</h2>
        <p>Kelola data profil sekolah yang tersimpan pada sistem sekolah.</p>
    </div>

    <!-- Button -->
    <div>
        <a href="pages/profil_sekolah/add.php" class="group inline-flex items-center rounded-lg py-4 px-6 gap-1.5 text-sm text-white font-poppins font-medium bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-[0_3px_4px_rgba(59,130,246,0.4)] transition duration-300">
...
<!-- Tabel Siswa -->
<div class="relative overflow-visible border border-gray-200 rounded-lg shadow-sm mt-16">
    <table class="w-full text-sm text-left">
        <thead class="font-poppins font-medium bg-gray-100 text-sm text-gray-700 sticky top-0 z-1 shadow-md">
            <tr>
                <th scope="col" class="px-4 py-5 font-bold text-gray-700 text-center">NO</th>
                <th scope="col" class="px-4 py-5 font-semibold text-gray-700">Nama Sekolah</th>
                <th scope="col" class="px-4 py-5 font-semibold text-gray-700">Kota & Alamat Sekolah</th>
                <th scope="col" class="px-8 py-5 font-semibold text-gray-700 text-center">Aksi</th>
            </tr>
        </thead>
        ...
        <tbody class="divide-y divide-gray-200">
            ...
            ?>
                <tr class="bg-white hover:bg-gray-100 font-medium font-poppins transition text-sm">
                    <td class="px-4 py-4 font-bold text-[16px] text-center"><?= $no++; ?></td>
                    <td class="px-4 py-4 font-medium"><?= $row['nama_sekolah']; ?></td>
