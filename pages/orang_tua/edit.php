...
$result = mysqli_query($conn, "SELECT * FROM ortu_wali WHERE id_ortu_wali = '$id'");
...
<form id="formOrang_tua" action="/poin_pelanggaran_siswa/process/orang_tua/update.php" method="POST">
    <input type="hidden" name="id_ortu_wali" value="<?= $data['id_ortu_wali']; ?>">
    <!-- Form Data Orang Tua -->
