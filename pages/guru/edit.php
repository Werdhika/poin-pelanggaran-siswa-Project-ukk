...
$query_kelas = mysqli_query($conn, "SELECT kelas.*, tingkat.tingkat, program_keahlian.program_keahlian
FROM kelas
...
<div class="flex justify-between items-center">
    <div>
        ...
        <div class="flex font-urbanist font-semibold">
            <a href="/poin_pelanggaran_siswa/pages/">Data Guru</a>
...
<!-- Form Data Siswa -->
<form id="formSiswa" action="/poin_pelanggaran_siswa/process/" method="POST">
    <div class="w-full mt-16 flex gap-8">
        <div class="flex-2">
            <div class="bg-white rounded-md shadow-md overflow-hidden">
                ...
                <!-- Input Data Siswa -->
                <div class="p-8 space-y-6 font-poppins text-sm font-semibold rounded-b-lg border-2 border-t-0 border-gray-200">
                    <div class="flex gap-4 w-full">
                        ...
                        <div class="flex-2">
                            ...
                            <input
                                ...
                                required
                                oninvalid="this.setCustomValidity('Nama siswa wajib diisi')"
                        ...
                        <div class="flex-1">
                            ...
                            <div class="relative">
                                <select
                                    ...
                                    required
                                    oninvalid="this.setCustomValidity('Kelas siswa wajib diisi')"
                                    oninput="this.setCustomValidity('')">
        ...
        <div class="flex-1">
            <div class="bg-white rounded-md shadow-md overflow-hidden">
                ...
                <div class="flex px-7 p-3.5 gap-3 text-gray-700 text-[18px] font-urbanist font-extrabold rounded-t-md items-center bg-gray-100 border-2 border-gray-200">
                        ...
                        <div class="flex gap-4">
                            <div class="w-full">
                                <label for="laki-laki" class="flex items-center gap-4 rounded-lg border border-gray-300 bg-white p-2.5 text-sm font-medium shadow-sm transition-colors hover:bg-zinc-50 has-checked:border-blue-600 has-checked:ring-1 has-checked:ring-blue-600 has-checked:bg-blue-100">
                                    ...
                                    <p class="text-gray-700 font-semibold">Laki-Laki</p>
                                    <input
                                        type="radio"
                                        name="jenis_kelamin"
                                        value="Laki - Laki"
                            ...
                            <div class="w-full">
                                <label for="perempuan" class="flex items-center gap-4 rounded-lg border border-gray-300 bg-white p-2.5 text-sm font-medium shadow-sm transition-colors hover:bg-zinc-50 has-checked:border-pink-600 has-checked:ring-1 has-checked:ring-pink-600 has-checked:bg-pink-100">
                                    ...
                                    <p class="text-gray-700 font-semibold">Perempuan</p>
                                    <input
                                        type="radio"
                                        name="jenis_kelamin"
                                        value="Perempuan"
