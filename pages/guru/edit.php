...
<!-- Form Data Edit Guru -->
<form id="formGuru" action="/poin_pelanggaran_siswa/process/guru/update.php" method="POST">
                    ...
                    <div class="flex-2">
                        ...
                        <div class="relative">
                            <select
                                ...
                                oninput="this.setCustomValidity('')">
                                <option
                                    value="" disabled selected hidden>Pilih Jabatan</option>
        ...
        <div class="flex-1">
            <div class="bg-white rounded-md shadow-md overflow-hidden">
                ...
                <div class="bg-white p-9 rounded-b-md space-y-6 font-poppins text-sm border-2 border-t-0 border-gray-200">
                    ...
                    <!-- Jenis Kelamin Siswa -->
                    <div>
                        <p class="block mb-2 font-semibold font-poppins">Role</p>
