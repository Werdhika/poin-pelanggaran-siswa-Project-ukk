...
<div class="flex justify-between items-start px-28">
    <div>
        <h2 class="font-urbanist font-extrabold text-3xl mb-2">Tambah Data Surat Pindah</h2>
        <p>Silahkan isi data surat pindah yang akan ditambahkan.</p>
    </div>
...
<form id="formSurat_pindah" action="/poin_pelanggaran_siswa/process/surat_pindah/insert.php" method="POST">
