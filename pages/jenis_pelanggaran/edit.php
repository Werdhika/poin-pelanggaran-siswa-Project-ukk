...
<div class="flex justify-between items-center px-28">
    <div>
        <h2 class="font-urbanist font-extrabold text-3xl mb-2">Edit Jenis Pelanggaran</h2>
        <p>Perbarui data jenis pelanggaran yang dipilih.</p>
    </div>
...
<form id="formPelanggaran" action="/poin_pelanggaran_siswa/process/jenis_pelanggaran/update.php" method="POST">
